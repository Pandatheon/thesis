...
\newacronym{FTB}   {FTB}   {Fraction-to-the-Boundary}
\newacronym{NMPC}  {NMPC}  {Nonlinear Model Predictive Control}
\newacronym{EM}    {EM}    {Eigenvalue Modification}
\newacronym{MC}    {MC}    {Modified Cholesky Factorization}
\newacronym{LM}    {LM}    {Levenberg--Marquardt}
\newacronym{SOSC}  {SOSC}  {Second-Order Sufficient Condition}
